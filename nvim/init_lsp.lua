  ...
  settings = {
      yaml = {
          ...
          schemas = {
              ...
              ["https://raw.githubusercontent.com/ansible/ansible-lint/main/src/ansiblelint/schemas/ansible.json#/$defs/playbook"] = "playbook*/*.y*ml",
              ["https://raw.githubusercontent.com/ansible/ansible-lint/main/src/ansiblelint/schemas/inventory.json"] = "inventory/*.y*ml",
          },
      },
      redhat = {
          telemetry = {
